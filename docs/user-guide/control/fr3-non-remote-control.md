...
- On the Dell Computer (Computer 3) desktop, double-click **FR3 Control GUI**.
- The GUI provides buttons to start kinesthetic teaching and visual servoing examples.
